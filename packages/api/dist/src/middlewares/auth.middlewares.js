...
exports.isNotLoggedIn = exports.isLoggedIn = exports.passportErrorHandler = void 0;
const Errors = __importStar(require("../global/response/error"));
const passportErrorHandler = (err, _req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    if (err) {
...
exports.passportErrorHandler = passportErrorHandler;
